...
//        Error_Handler();
    ...
    if( motor_init(motor_2_dir, motor_2_step, 0, true, 0, 0,  &motor_2)) {
//        Error_Handler();
    }
    if( motor_init(motor_3_dir, motor_3_step, 0, true, 0, 0,  &motor_3)) {
//        Error_Handler();
    }
    if( motor_init(motor_4_dir, motor_4_step, 0, true, 0, 0,  &motor_4)) {
//        Error_Handler();
    }
